...
import profile from "../../assets/dharun-modified.png";
import Aos from 'aos'
...
function Aboutme() {
  ...
  return (
    <div id="about"className="mx-5 font-pop">
      <div className="about-continer">
        ...
        <p data-aos="fade-up" data-aos-anchor-placement="top-bottom" className="text-center  font-light">
          Hi There! I'm <span className="text-red-600">Dharun</span>  R, I'm a Software Engineer and a python
        ...
        <p data-aos="fade-up" data-aos-anchor-placement="top-bottom" className="mt-3 mb-20 h-32 text-center font-light">
